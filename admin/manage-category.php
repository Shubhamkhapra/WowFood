        			...
        			while($row = mysqli_fetch_assoc($res))
        			{
        				...
        				<tr>
			        		...
			        		<td> 
								...
								<a href="./update-category.php?id=<?php echo $id; ?>" class="text-warning" > <span class="material-symbols-outlined">edit </span> </a>



			        			<a href="./delete-category.php?id=<?php echo $id ; ?>&image_name=<?php echo $image_name; ?>"  class="text-danger"> <span class="material-symbols-outlined">
                                delete
                                </span> </a>
